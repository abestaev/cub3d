...
/*   Updated: 2024/10/18 18:28:20 by melmarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_init_doors_text(t_player *p)
{
	t_doors *doors = malloc(sizeof(t_doors));
	ft_memset(doors, 0, sizeof(t_doors));

	p->doors = doors;
	p->doors->text_doors = malloc(sizeof(int *) * 9);
...
static void	ft_init_wall_textures(t_player *p)
{
